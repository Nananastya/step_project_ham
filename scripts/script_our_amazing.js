...
function createNewLi(className, link){
    let newLi = document.createElement('li');
    newLi.classList.add(className);
    let newImg = document.createElement('img');
    let newDiv = document.createElement('div');
    newDiv.classList.add('creative-design');
    newImg.src = link;
    newDiv.innerHTML = `
    ...
    newLi.append(newImg);
    newLi.append(newDiv);
    let spanLiType = newDiv.querySelector('.li-type');
    if (className === "graphic-design"){
        spanLiType.textContent = 'Graphic Design';
    }
    else if (className === "web-design"){
        spanLiType.textContent = 'Web Design';
    }
    else if (className === "landing-pages"){
        spanLiType.textContent = 'Landing Pages';
    }
    else if (className === "wordpress"){
        spanLiType.textContent = 'Wordpress';
    }
    gridMenu.append(newLi);
}
...
btnGridMenu.addEventListener('click', (event) => {
    ...
    if (variable === 0){
        createNewLi('web-design', './imgs/web_design/web-design5.jpg');
        createNewLi('web-design', './imgs/web_design/web-design6.jpg');
        createNewLi('web-design', './imgs/web_design/web-design7.jpg');
        createNewLi('web-design', './imgs/web_design/web-design8.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page1.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page2.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page3.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page4.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page5.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page6.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page7.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page8.jpg');
        variable++;
        ...
        createNewLi('landing-pages', './imgs/landing_page/landing-page3.jpg');
        createNewLi('landing-pages', './imgs/landing_page/landing-page4.jpg');
        createNewLi('wordpress', './imgs/wordpress/wordpress1.jpg');
        createNewLi('wordpress', './imgs/wordpress/wordpress2.jpg');
        createNewLi('wordpress', './imgs/wordpress/wordpress3.jpg');
        createNewLi('wordpress', './imgs/wordpress/wordpress4.jpg');
        createNewLi('wordpress', './imgs/wordpress/wordpress5.jpg');
        createNewLi('wordpress', './imgs/wordpress/wordpress6.jpg');
        createNewLi('wordpress', './imgs/wordpress/wordpress7.jpg');
        createNewLi('wordpress', './imgs/wordpress/wordpress8.jpg');
        variable++;
        console.log (variable);
        btnGridMenu.style.display = "none";
    }
